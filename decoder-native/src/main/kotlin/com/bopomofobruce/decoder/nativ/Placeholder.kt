 ...
 * and [ADR-0006](../../../../../../../../docs/adr/0006-libchewing-rust-build-pipeline.md)),
 * produces `libbpmf.so`, and exposes the C API (`cmake/include/bpmf.h`) plus the Kotlin
 * asset-extraction helper ([ChewingDataPath]). JNI binding of `libbpmf.so` itself is out of scope
 * here — that's W2-A's `:decoder`.
 *
